...
res_2 = lambda list_n, list_s, list_a: {name: salary * float(award[0:len(award)-1]) / 100
                                    for name, salary, award in zip(list_n, list_s, list_a)}
print(res_2(names, salaries, awards))